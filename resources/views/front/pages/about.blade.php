        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            <a href="#" class="me-4 thumbnail">
              <img src="{{asset('projects/front/img/post-landscape-2.jpg')}}" alt="" class="img-fluid">
            </a>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="{{asset('projects/front/img/post-landscape-2.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
